      ...
      <div class="container">
          ...
          <div class="row">
                ...
                <div class="col-12 text-center my-5"> <!-- "my-5", "my" eh a margem em todo eixo Y da pagina, e de 1 a 5 eh o tamanho. -->
                    ...
                    <!-- subtitulo -->
                    <p class="h5"><em>Este é um site fictício, conteúdo apenas para demonstração de conhecimentos em FrontEnd e BOOTSTRAP4.<br>
                        Todo conteúdo do site ao ser clicado, ou passar o mouse por cima executa alguma ação (até icones de engrenagem).</em></p>
                </div>
    ...
    <!-- FIM do container -->
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-8">
                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-4 mb-5 col-md-6">
                                    ...
                                    <!-- POPOVER Javascript -->
                                    <!-- "data-placement" eh onde ele vai aparecer, o "data-trigger=focus" sem ele, a ajuda fica aberta ate clicar novamente -->
                                    <a tabindex="0" class="btn btn-secondary ml-4" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" title="Fique calmo" data-content="Estamos aqui para lhe ajudar, clique em enviar para nos enviar seus dados, e limpar para limpar o formulario.">Ajuda</a>
                                
                                    <button type="reset" class="btn btn-danger ml-2">Limpar</button>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p class="text-justify">
                Não deixe de acessar nossas redes sociais, nos seguir, nos curtir, e principalmente assinar nossos canais. Aqui nesta área também temos nosso menu de perfils e serviços. 
                </p>
                <p class="text-justify">
                    Aqui nesta sessão você analisar a qualidade dos nossos botões criados.
                </p>
            ...
            <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="btn-group-vertical btn-block btn-group-lg" role="group">
                        ...
                        <a class="btn btn-primary" href="https://www.facebook.com/" target="_blanck">Facebook</a>
                        <a class="btn btn-info" href="https://twitter.com/" target="_blanck">Twitter</a>
                        <a class="btn btn-warning" href="https://www.instagram.com/?hl=pt-br" target="_blanck">Instagran</a>
                    ...
                    <div class="btn-group-vertical btn-block btn-group-lg" role="group">
                        ...
                        <a class="btn btn-outline-primary" href="https://www.facebook.com/" target="_blanck"><i class="fab fa-facebook-square" aria-hidden="true"></i>Facebook</a>
                        <a class="btn btn-outline-info" href="https://twitter.com/" target="_blanck"><i class="fab fa-twitter-square" aria-hidden="true"></i>Twitter</a>
                        <a class="btn btn-outline-warning" href="https://www.instagram.com/?hl=pt-br" target="_blanck"><i class="fab fa-instagram" aria-hidden="true"></i>Instagran</a>
